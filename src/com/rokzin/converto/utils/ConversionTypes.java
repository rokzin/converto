...
public class ConversionTypes {
	...
	public static String[] getCurrencyTypes() {
		...
		String currencyTypes[] = {"AED","ALL","ANG","ARS","AUD","AWG","BBD","BDT","BGN","BHD","BIF","BMD","BND","BOB","BRL","BSD","BTN","BWP","BYR","BZD","CAD","CHF","CLP","CNY","COP","CRC","CUP","CVE","CZK","DJF","DKK","DOP","DZD","EGP","ETB","EUR","FJD","FKP","GBP","GIP","GMD","GNF","GTQ","GYD","HKD","HNL","HRK","HTG","HUF","IDR","ILS","INR","IQD","IRR","ISK","JMD","JPY","KES","KHR","KMF","KPW","KRW","KWD","KZT","LAK","LBP","LKR","LRD","LSL","LTL","LVL","LYD","MAD","MDL","MKD","MMK","MNT","MOP","MRO","MUR","MVR","MWK","MXN","MYR","NAD","NGN","NIO","NOK","NPR","NZD","OMR","PAB","PEN","PGK","PHP","PKR","PLN","PYG","QAR","RUB","RWF","SAR","SBD","SCR","SEK","SGD","SHP","SLL","SOS","STD","SVC","SYP","SZL","THB","TND","TOP","TRY","TTD","TWD","TZS","UAH","USD","UYU","VEF","VND","VUV","WST","XAF","XAG","XAU","XCD","XCP","XOF","XPD","XPF","XPT","YER","ZAR","ZMK"};
